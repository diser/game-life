...
import org.jboss.as.quickstarts.ejbinwar.ejb.GameLifeEJB;
...
@Named("gamelife")
@SessionScoped
public class GameLife implements Serializable {

    /**
     * Injected GreeterEJB client
     */
    @EJB
    private GameLifeEJB gameLifeEJB;
    ...
    public void setName(String name) {
        message = gameLifeEJB.sayHello(name);
    }
    ...
    public String getAliveString() {
        return gameLifeEJB.getAliveString();
    }
